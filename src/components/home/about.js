...
const items = [
  {
    ...
    content: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Velit necessitatibus officiis repudiandae est deserunt.',
  },
  {
    key: '2',
    icon: <i className="fas fa-desktop"></i>,
    title: 'Digital',
    content: 'Magnam aut a porro, adipisci quidem sint enim pariatur ducimus, saepe voluptatibus inventore commodi! Quis, explicabo molestias',
  },
  {
    key: '3',
    ...
    <div id="about" className="block aboutBlock">
      <div className="container-fluid">
        <div className="titleHolder">
          <h2>About Us</h2>
          <p>A healthcare landmark in Mumbai</p>
        </div>
